...
function cleanKeychain(uuid) {
    process.exec('/Users/twe/Documents/fbsimctl/fbsimctl ' + uuid + ' clear_keychain com.thoughtworks.StartKit',
...
function cleanAllKeychains() {
    process.exec('/Users/twe/Documents/fbsimctl/fbsimctl --state=booted clear_keychain com.thoughtworks.StartKit',
        function (err, stdout, stderr) {
            if (err) {
                sleep(3000).then(() => {
                    console.log("Take 3 seconds...")
...
function uninstallApp(uuid) {
    process.exec('/Users/twe/Documents/fbsimctl/fbsimctl ' + uuid + ' uninstall com.thoughtworks.StartKit', function (err, stdout, stderr) {
        if (err) {
            sleep(3000).then(() => {
                console.log("Take 3 seconds...")
            });
...
function installApp(uuid) {
    process.exec('/Users/twe/Documents/fbsimctl/fbsimctl ' + uuid + ' install /Users/twe/Downloads/com.thoughtworks.StartKit',
        function (err, stdout, stderr) {
            if (err) {
                sleep(3000).then(() => {
                    console.log("Take 3 seconds...")
